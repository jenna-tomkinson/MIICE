...
First of all, thank you so much for contributing to MIICE! 🐭💡
...
Please open a new security advisory notice (using defaults or "n/a" where unable to fill in the form) to privately notify us of any incidents of this nature.
...
We also use the `__init__.py` file as a place to persist the version data for occasions where the `git` history is unavailable or unwanted.
...
## TODO: Add releases and documentation when PyPi project is created

## Attribution

This contributing file has been adapted from coSMicQC software, available at <https://github.com/cytomining/coSMicQC/blob/main/docs/src/contributing.md>.
